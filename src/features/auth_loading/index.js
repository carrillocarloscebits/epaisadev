...
import {View, Text, StyleSheet, AsyncStorage, Dimensions, ImageBackground, Image} from 'react-native';
...
export default class AuthLoading extends Component {
    ...
    render() {
        return (
            <ImageBackground
                source={ this.state.orientation ? require('../../assets/images/bg/loadingBackground.png') :
