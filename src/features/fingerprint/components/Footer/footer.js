    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <TouchableOpacity style={[styles.button, {backgroundColor: 'white'}]} onPress={this.props.onReject}>
                    <Text style={styles.labelButtonWhite} >NOT NOW</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.button, {backgroundColor: 'red'}]} onPress={linkFingerprint}>
                <LinearGradient 
