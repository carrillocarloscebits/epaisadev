    ...
    return async (dispatch) => {
        ...
        try{
            ...
            if(res.email.exists) {
                ...
                userService.opt_send(email, 'email')
                .then(res => {
                    if(res.success) {
...
export function check_mobile(mobile) {
    return async (dispatch) => {
        ...
        try{
            ...
            if(res.mobile.exists) {
                dispatch(sendOpt(res))
                userService.opt_send(mobile, 'mobile')
                .then(res => {
                    console.log(res)
                    if(res.success) {
    ...
    function request() { return { type: userConstants.CHECK_MOBILE_REQUEST } }
    function failureCheck(payload) { return { type: userConstants.CHECK_MOBILE_FAILURE, payload } }
    function sendOpt(payload) { return { type: userConstants.OTP_MOBILE_REQUEST, payload } }
    function sendOptSuccess(payload) { return { type: userConstants.OTP_MOBILE_SUCCESS, payload } }
}